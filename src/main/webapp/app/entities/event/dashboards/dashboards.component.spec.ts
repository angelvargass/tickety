...
describe('Event Management Component', () => {
  let comp: DashboardsComponent;
  let fixture: ComponentFixture<DashboardsComponent>;
  let service: EventService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'event', component: DashboardsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DashboardsComponent, '')
      .compileComponents();
