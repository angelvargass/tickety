...
class ContactResourceIT {
    ...
    void createContact() throws Exception {
        ...
        assertThat(testContact.getInstagram()).isEqualTo(DEFAULT_INSTAGRAM);
    ...
    void putExistingContact() throws Exception {
        ...
        updatedContact.phone(UPDATED_PHONE).instagram(UPDATED_INSTAGRAM).facebook(UPDATED_FACEBOOK).whatsapp(UPDATED_WHATSAPP);
        ...
        assertThat(testContact.getInstagram()).isEqualTo(UPDATED_INSTAGRAM);
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.phone(UPDATED_PHONE).facebook(UPDATED_FACEBOOK).whatsapp(UPDATED_WHATSAPP);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.phone(UPDATED_PHONE).instagram(UPDATED_INSTAGRAM).facebook(UPDATED_FACEBOOK).whatsapp(UPDATED_WHATSAPP);
