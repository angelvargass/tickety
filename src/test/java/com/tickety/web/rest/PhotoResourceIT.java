...
import com.tickety.repository.PhotoRepository;
...
class PhotoResourceIT {
    ...
    private static final PhotoStatus DEFAULT_STATUS = PhotoStatus.ACTIVE;
    private static final PhotoStatus UPDATED_STATUS = PhotoStatus.INSTACTIVE;
    ...
    public static Photo createEntity(EntityManager em) {
        Photo photo = new Photo().url(DEFAULT_URL).status(DEFAULT_STATUS);
        return photo;
    }
    ...
    public static Photo createUpdatedEntity(EntityManager em) {
        Photo photo = new Photo().url(UPDATED_URL).status(UPDATED_STATUS);
        return photo;
    }
    ...
    void createPhoto() throws Exception {
        ...
        assertThat(testPhoto.getStatus()).isEqualTo(DEFAULT_STATUS);
    }
    ...
    void putExistingPhoto() throws Exception {
        ...
        updatedPhoto.url(UPDATED_URL).status(UPDATED_STATUS);
        ...
        assertThat(testPhoto.getStatus()).isEqualTo(UPDATED_STATUS);
    }
    ...
    void fullUpdatePhotoWithPatch() throws Exception {
        ...
        partialUpdatedPhoto.url(UPDATED_URL).status(UPDATED_STATUS);
