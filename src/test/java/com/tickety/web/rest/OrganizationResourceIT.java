...
class OrganizationResourceIT {
    ...
    public static Organization createEntity(EntityManager em) {
        Organization organization = new Organization().name(DEFAULT_NAME).owner(DEFAULT_OWNER);
        return organization;
    }
    ...
    public static Organization createUpdatedEntity(EntityManager em) {
        Organization organization = new Organization().name(UPDATED_NAME).owner(UPDATED_OWNER);
        return organization;
    }
    ...
    void putExistingOrganization() throws Exception {
        ...
        updatedOrganization.name(UPDATED_NAME).owner(UPDATED_OWNER);
    ...
    void fullUpdateOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedOrganization.name(UPDATED_NAME).owner(UPDATED_OWNER);
