...
class EventResourceIT {
    ...
    private static final EventSatus DEFAULT_EVENT_SATUS = EventSatus.OPEN;
    private static final EventSatus UPDATED_EVENT_SATUS = EventSatus.CLOSED;
    ...
    void partialUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.eventSatus(UPDATED_EVENT_SATUS);
